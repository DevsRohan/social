<?php
/**
 * Plugin Name: Social Proof LIVE (Trial)
 * Plugin URI: https://devsarun.io/plugin/chat/
 * Description: 24-HOUR FREE TRIAL — full Social Proof LIVE with every feature unlocked (live viewers, cart activity, recent purchases, demand score, FOMO popups, stock urgency, countdowns, visitor badge, A/B conversion proof). A live countdown shows time left; the plugin removes itself automatically after 24 hours. Upgrade to Pro at https://devsarun.io/plugin/chat/
 * Version: 1.2.0
 ...
 * Plugin constants.
 */
define( 'SPLIVE_TRIAL', true ); // 24-hour self-expiring trial build.
